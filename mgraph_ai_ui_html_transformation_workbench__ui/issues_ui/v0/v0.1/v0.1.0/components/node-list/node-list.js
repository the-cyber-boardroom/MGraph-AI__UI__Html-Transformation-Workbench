...
class NodeList extends HTMLElement {
    ...
    getAvailableStatuses() {
        if (this.state.typeFilter === 'all') {
            ...
            Object.values(window.issuesApp.nodeTypes).forEach(type => {
    ...
    getStyles() {
        return `
            ...
            .nl-toolbar { display: flex; gap: 10px; }
            ...
            .nl-btn-primary { background: #e94560; color: white; }
            .nl-btn-primary:hover { background: #d63850; }
            .nl-btn-secondary { background: #3a4f6f; color: #e0e0e0; }
            .nl-btn-secondary:hover { background: #4a5f7f; }
            ...
            .nl-type-filter { display: flex; gap: 8px; flex-wrap: wrap; }
            ...
            .nl-type-btn:hover { background: rgba(255, 255, 255, 0.05); }
            ...
            .nl-select:focus, .nl-input:focus { outline: none; border-color: #e94560; }

            .nl-content { flex: 1; overflow-y: auto; }

            .nl-table { width: 100%; border-collapse: collapse; }

            .nl-table thead { background: #1e2746; position: sticky; top: 0; }
            ...
            .nl-row:hover { background: rgba(233, 69, 96, 0.1); }
            ...
            .nl-cell-links { text-align: center; }
            ...
            .nl-cell-updated { color: #8a9cc4; font-size: 12px; }
            ...
            .nl-loading, .nl-error { padding: 60px; text-align: center; color: #8a9cc4; }
            .nl-error { color: #e94560; }
            ...
            .nl-empty-title { font-size: 18px; font-weight: 600; color: #fff; margin-bottom: 8px; }
            .nl-empty-text { color: #8a9cc4; }
        `;
    }
