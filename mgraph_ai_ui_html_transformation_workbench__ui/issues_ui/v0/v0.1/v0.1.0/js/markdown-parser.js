...
(function() {
    ...
    class MarkdownParser {
        ...
        _emitParsed(markdown, html) {
            if (window.issuesApp && window.issuesApp.events) {
                window.issuesApp.events.emit('markdown-parsed', {
    ...
    window.issuesApp.markdown = new MarkdownParser();

    console.log('[Issues UI v0.1.0] Markdown parser service initialized');
