 ...
 * Version: v0.1.1 (Issues UI) - Surgical Override
 *
...
class ApiLogger extends HTMLElement {
    ...
    getStyles() {
        return `
            ...
            .al-filter-input:focus { outline: none; border-color: #e94560; }
...
console.log('[Issues UI v0.1.1] API Logger component initialized');
