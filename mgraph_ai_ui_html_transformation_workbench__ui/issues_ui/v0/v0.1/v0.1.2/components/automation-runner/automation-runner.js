/**
 * Automation Runner for Issues UI
 *
 * Purpose: Run predefined automation scenarios for Issues UI testing
 * Version: v0.1.2 (Issues UI)
 *
 * Provides automation scenarios for:
 * - Creating issues
 * - Browsing issue lists
 * - Navigating between views
 * - Testing API endpoints
 */

// Built-in automation scenarios for Issues UI
const ISSUES_AUTOMATION_SCENARIOS = [
    {
    ...
    },
    {
        ...
        description: 'Open the create modal for a new bug',
        category: 'create',
        steps: [
            {
                type: 'navigate',
    ...
    },
    {
        ...
        description: 'Open the create modal for a new feature',
        category: 'create',
        steps: [
            {
                type: 'navigate',
    ...
    },
    {
        id: 'test-nodes-api',
        name: 'Test Nodes API',
        description: 'Call the nodes API endpoint and view results',
        category: 'api',
        steps: [
            {
                type: 'sidebar',
    ...
    },
    {
        ...
        description: 'Fetch node types configuration',
        category: 'api',
        steps: [
            {
                type: 'sidebar',
            ...
            },
            {
                type: 'api',
                service: 'nodes',
                endpoint: '/nodes/api/config/node-types',
                method: 'GET'
            }
        ]
    },
    ...
    },
    {
        ...
        description: 'Browse issues, view details, and test API',
        category: 'demo',
        steps: [
            {
                type: 'sidebar',
...
class AutomationRunner extends HTMLElement {
    ...
    constructor() {
        super();
        this.state = {
            scenarios: ISSUES_AUTOMATION_SCENARIOS,
            customScenarios: [],
            running: false,
    ...
    _loadCustomScenarios() {
        try {
            const saved = localStorage.getItem('issues-automation-scenarios');
            if (saved) {
    ...
    _saveCustomScenarios() {
        try {
            localStorage.setItem('issues-automation-scenarios', JSON.stringify(this.state.customScenarios));
        } catch (e) {
    ...
    render() {
        ...
        this.innerHTML = `
            ...
            <div class="automation-runner">
                <div class="ar-header">
                    <h3>Issues Automation</h3>
                    <p class="ar-subtitle">Run scenarios to test issue workflows</p>
                </div>
    ...
    get api() { return window.issuesApp.api; }
